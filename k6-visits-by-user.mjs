...
const PATH = __ENV.PATH || '/api-staging/pharma/reports/visits/by-user';
const START_DATE = __ENV.START_DATE || '1963-11-18';
const END_DATE = __ENV.END_DATE || '1963-11-18';
const AUTH_TOKEN = __ENV.AUTH_TOKEN;

if (!AUTH_TOKEN) {
  throw new Error('AUTH_TOKEN is required for the visits-by-user test');
}

export default function () {
  const url = `${BASE}${PATH}?start_date=${encodeURIComponent(START_DATE)}&end_date=${encodeURIComponent(END_DATE)}`;
